    ...
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[600px]">
            ...
            <div className="absolute top-1/2 w-full text-center">
                ...
                <button className="text-black bg-white px-10 py-3 shadow-md rounded-full my-3 banner-button active:scale-90 transition duration-150 font-bold">I'm flexible</button>
            </div>
        </div>
    )
}
